 ...
 */
final class Version20200120145359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE create_at created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE created_at create_at DATETIME NOT NULL');
